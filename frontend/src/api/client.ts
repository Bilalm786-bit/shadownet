...
export const casesAPI = {
  ...
  create: (data: { name: string; description?: string; priority?: number; tags?: string[] }) =>
    api.post('/cases/', data),
...
export const targetsAPI = {
  ...
  create: (caseId: string, data: { target_type: string; value: string; label?: string }) =>
    api.post(`/cases/${caseId}/targets/`, data),
  delete: (caseId: string, targetId: string) => api.delete(`/cases/${caseId}/targets/${targetId}`),
};

// OSINT Scanning
export const osintAPI = {
  scan: (data: { target_id: string; modules?: string[]; options?: any }) =>
    api.post('/osint/scan', data),
...
export const cursorAgentAPI = {
  create: (data: { prompt: string; repo_url: string; starting_ref?: string; model_id?: string; auto_create_pr?: boolean; branch_name?: string }) =>
    api.post('/cursor-agent/create', data),
